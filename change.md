...
- [x] Add a timer. Defenders win when timer expires. Timer length should be configured in config.yml
...
- [x] Change the TNT in the shop to instant tnt (existing custom item)
